...
def eval_genomes(genomes, config):
    ...
    while running:
        ...
        dots_to_remove_rk = []
        dots_to_remove_rl = []
        expectancy_i, expectancy_j, expectancy_k, expectancy_l = 0.019, 0.009, 0.02, 0.005
        len_li = 0
        len_ti = 0
        len_ri = 0
        len_lj = 0
        ...
        if iteration_counter == 1:
            ...
            print(f"Queue Length First: {fitness}")
            ...
            op = output[0]
            op = op*10
            print(output, len_phase_i, len_phase_j, len_phase_k, len_phase_l)
            o_m = op * (len_phase_i/(len_phase_i+len_phase_j+len_phase_k+len_phase_l))
            o_n = op * (len_phase_j/(len_phase_i+len_phase_j+len_phase_k+len_phase_l))
            o_o = op * (len_phase_k/(len_phase_i+len_phase_j+len_phase_k+len_phase_l))
            o_v = op * (len_phase_l/(len_phase_i+len_phase_j+len_phase_k+len_phase_l))
...
if __name__ == '__main__':
    ...
    config_path = os.path.join(os.path.dirname(__file__), r'C:\Users\shaai\PycharmProjects\pythonProject\Python-NEAT\config.txt')
    run(config_path)
